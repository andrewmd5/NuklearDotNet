...
namespace NuklearDotNet {
	...
	public unsafe struct nk_allocator {
		...
		public delegate* unmanaged[Cdecl]<NkHandle, void*, nuint, void*> alloc;
	...
	[StructLayout(LayoutKind.Sequential)]
	public unsafe struct nk_memory {
		public void* ptr;
		public nuint size;
	}
	...
	public unsafe struct nk_pool {
		...
		public nuint size_nksize;
		public nuint cap_nksize;
	}
	...
	public static unsafe partial class Nuklear {
		...
		public static partial int nk_init_fixed(nk_context* context, void* memory, nuint size, nk_user_font* userfont);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial int nk_init(nk_context* context, nk_allocator* allocator, nk_user_font* userfont);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial int nk_init_custom(nk_context* context, nk_buffer* cmds, nk_buffer* pool, nk_user_font* userfont);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_clear(nk_context* context);
		...
		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_init(nk_buffer* buffer, nk_allocator* allocator, nuint size);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_init_fixed(nk_buffer* buffer, void* memory, nuint size);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_info(nk_memory_status* status, nk_buffer* buffer);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_push(nk_buffer* buffer, nk_buffer_allocation_type atype, void* memory, nuint size, nuint align);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_mark(nk_buffer* buffer, nk_buffer_allocation_type atype);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_reset(nk_buffer* buffer, nk_buffer_allocation_type atype);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_clear(nk_buffer* buffer);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_free(nk_buffer* buffer);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void* nk_buffer_memory(nk_buffer* buffer);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void* nk_buffer_memory_const(nk_buffer* buffer);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial nuint nk_buffer_total(nk_buffer* buffer);

		// Functions enabled by NK_INCLUDE_DEFAULT_ALLOCATOR
		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial int nk_init_default(nk_context* context, nk_user_font* userfont);

		[LibraryImport(DllName)]
		[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
		public static partial void nk_buffer_init_default(nk_buffer* buffer);
	}
}
